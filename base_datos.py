...
micursor.execute("create table  if no exists clientes (id int primary key auto_increment, codigo text (50),nombre text (50), direccion text (50), telefono text(50), situacion text (50))")
micursor.execute("create table if no exists peliculas(id int primary key auto_increment, codigo text (50),nombre_peli text (50),genero text(50),situacion text (50))")
...
sql = "INSERT INTO clientes(codigo, nombre_peli, genero, situacion) VALUES (%s, %s, %s, %s, %s)"
val =[
